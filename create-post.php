...
if ($result1) {
	...
	$sql_query2 = "insert into POST (POSTID, BODY, POSTTIME_STAMP, POST_POSTID, PARENTPOSTID, MEMBERS_EMAIL_ID) values (($rows + 1), '$content', (select CURRENT_TIMESTAMP from DUAL), ($rows + 1), ($rows + 1), '$email_id')";
