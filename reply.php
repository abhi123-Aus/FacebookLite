...
if ($result1) {
	...
	$sql_query2 = "insert into POST (POSTID, BODY, POSTTIME_STAMP, POST_POSTID, PARENTPOSTID, MEMBERS_EMAIL_ID) values (($rows + 1), '$reply', (select CURRENT_TIMESTAMP from DUAL), $post_postid, $parentpostid, '$email_id')";
